...
public class RequestApplicationServiceImpl implements RequestApplicationService {
    ...
    @Override
    public DisplayRequestDto create(User user, CreateRequestDto createRequestDto) {
        Municipality municipality = municipalityService.findById(createRequestDto.municipalityId());
        return DisplayRequestDto.from(requestService.create(createRequestDto.toRequest(user, municipality)));
    }
